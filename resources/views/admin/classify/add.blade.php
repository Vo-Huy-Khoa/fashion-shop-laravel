...
<div class="container-fluid" id="container-wrapper">
    <div class="wrapper bg-white mt-sm-4">
        ...
        @endif
        <form action="{{route('classify_add')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row py-2">
                <!-- Uploaded image area-->
                <div class="image-area mt-4">
                    <img style="height: 300px; width:300px; boder-radius:50px;" id="imageResult" src="#" alt="" class="img-fluid rounded shadow-sm mx-auto d-block">
                </div>
            </div>
            <div class="row py-2">
                <!-- Upload image input-->
            ...
            <div class="py-2">
                ...
                <input type="text" class="bg-light form-control" placeholder="Enter Classify Name..." id="name" name="name">
