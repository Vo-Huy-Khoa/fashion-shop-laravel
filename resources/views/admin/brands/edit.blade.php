...
<div class="container-fluid" id="container-wrapper">
    <div class="wrapper bg-white mt-sm-4">
        ...
        <form action="admin/brands/edit/{{$brands->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row py-2">
                <!-- Uploaded image area-->
                <div class="image-area mt-4"><img style="height: 300px; width:300px; boder-radius:50px;" id="imageResult" src="uploads/brands/{{$brands->image}}" alt="" class="img-fluid rounded shadow-sm mx-auto d-block"></div>
            </div>
            <div class="row py-2">

                <!-- Upload image input-->
                <div class="input-group  rounded-pill bg-white shadow-sm">
                    <input id="upload" name="img" type="file" value="{{$brands->image}}" onchange="readURL(this);" class="form-control border-0">
            ...
            <div class="py-2">
                <div class="row py-2">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="bg-light form-control" value="{{$brands->name}}" id="name" name="name">
                    </div>
                </div>
