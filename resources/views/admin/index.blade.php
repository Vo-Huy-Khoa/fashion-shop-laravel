...
<head>
  ...
  {{-- DataTable --}}
  <link rel="stylesheet" href="{{ URL::asset('admin/vendor/datatables/dataTables.bootstrap4.min.css') }}">
  {{-- User --}}
  ...
  <link rel="stylesheet" href="{{ URL::asset('admin/css/message.css') }}">
  {{-- Css input --}}
  <link rel="stylesheet" href="{{ URL::asset('admin/css/input.css') }}">
  <base href="{{asset('')}}">
</head>
