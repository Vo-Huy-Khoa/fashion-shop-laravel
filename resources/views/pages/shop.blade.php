                    ...
                    <div class="form-check form-check-inline">
                        <div class="colors">
                            <label>
                                ...
                                <a href="search-size/{{$sizes->id}}"><span class="swatch" style="background-color:#7FAD39;color:black;font-weight:bold;line-height:30px; text-align:center">{{ $sizes->value }}</span>
                                </a>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="product__discount__slider owl-carousel">
                            ...
                            <div class="col-lg-4">
                                <div class="product__discount__item">
                                    <div class="product__discount__item__pic set-bg" data-setbg="uploads/products/{{$products_sale->image}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="filter__found">
                                <h6><span><?php echo count($list_products); ?></span>Sản phẩm được tìm thấy</h6>
                            </div>
                        </div>
